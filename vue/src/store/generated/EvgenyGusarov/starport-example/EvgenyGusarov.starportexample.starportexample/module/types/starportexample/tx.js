...
export const protobufPackage = "EvgenyGusarov.starportexample.starportexample";
...
export class MsgClientImpl {
    ...
    CreatePost(request) {
        ...
        const promise = this.rpc.request("EvgenyGusarov.starportexample.starportexample.Msg", "CreatePost", data);
        return promise.then((data) => MsgCreatePostResponse.decode(new Reader(data)));
    }
    UpdatePost(request) {
        const data = MsgUpdatePost.encode(request).finish();
        const promise = this.rpc.request("EvgenyGusarov.starportexample.starportexample.Msg", "UpdatePost", data);
        return promise.then((data) => MsgUpdatePostResponse.decode(new Reader(data)));
    }
    DeletePost(request) {
        const data = MsgDeletePost.encode(request).finish();
        const promise = this.rpc.request("EvgenyGusarov.starportexample.starportexample.Msg", "DeletePost", data);
