...
import { Post } from "../starportexample/post";
...
export class QueryClientImpl {
    ...
    Post(request) {
        ...
        const promise = this.rpc.request("EvgenyGusarov.starportexample.starportexample.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("EvgenyGusarov.starportexample.starportexample.Query", "PostAll", data);
